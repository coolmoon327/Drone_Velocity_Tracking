...
from .Aviary_FrontVelocity import Aviary_FrontVelocity
...
def evaluate(filename):
    ...
    test_env = Aviary_FrontVelocity(gui=DEFAULT_GUI,
                            obs=DEFAULT_OBS,
                            act=DEFAULT_ACT,
                            pyb_freq=DEFAULT_SIMULATION_FREQ_HZ,
                            ctrl_freq=DEFAULT_CONTROL_FREQ_HZ,
                            record=DEFAULT_RECORD_VIDEO)
    test_env_nogui = Aviary_FrontVelocity(obs=DEFAULT_OBS, act=DEFAULT_ACT, pyb_freq=DEFAULT_SIMULATION_FREQ_HZ, ctrl_freq=DEFAULT_CONTROL_FREQ_HZ)
...
def train(filename):
    train_env = make_vec_env(Aviary_FrontVelocity,
